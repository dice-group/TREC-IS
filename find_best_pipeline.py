...
tpot = TPOTClassifier(periodic_checkpoint_folder='tpot_progress.txt',warm_start=True, early_stop=1000, random_state=42, n_jobs= -1)

X_train, X_test, y_train, y_test = train_test_split(data['bow_features'].tolist(), data['categories'].tolist(),
                                                    train_size=0.75, test_size=0.25)

tpot.fit(X_train, y_train)
print(tpot.score(X_test, y_test))
tpot.export('tpot_bow_pipeline.py')
...
tpot.fit(X_train, y_train)
print(tpot.score(X_test, y_test))
tpot.export('tpot_boc_pipeline.py')
...
tpot.fit(X_train, y_train)
print(tpot.score(X_test, y_test))
tpot.export('tpot_bow_boc_pipeline.py')
